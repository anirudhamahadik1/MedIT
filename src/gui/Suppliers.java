...
public class Suppliers extends JInternalFrame {
	...
	public Suppliers() {
		setClosable(true);
		setIconifiable(true);
		setTitle("Medical Inventory Management: Suppliers");
		...
		btnAdd.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if(addname.equals("") || addcontact.equals("") || addaddress.equals("")){
					...
					lblACVal.setText("");
					lblAAVal.setText("");
					ProcessSupplier PSO = new ProcessSupplier();
					PSO.addDetails(addname, addcontact, addaddress);
